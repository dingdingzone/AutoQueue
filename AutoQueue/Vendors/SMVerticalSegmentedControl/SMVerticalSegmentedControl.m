...
#define DEFAULT_SELECTION_INDICATOR_COLOR   [ProSetting getColorByStr:@"cc3333"]
#define DEFAULT_SEGMENT_EDGE_INSET          UIEdgeInsetsMake(5, 5, 5, 5);
#define DEFAULT_BOX_BACKGROUND_COLOR_ALPHA  0.0f;
...
- (void)drawRect:(CGRect)rect
{
    ...
    self.selectionIndicatorBoxLayer.borderColor = [UIColor whiteColor].CGColor;
